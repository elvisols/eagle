 ...
 */
@Entity
@Table(name="finacle.dth")
@NamedQueries( {
	@NamedQuery(name = "DTH.findByCustId", query = "select c from GAM c  where  c.cust_id = :cust_id")
})
public class DTH implements Serializable{
	private static final long serialVersionUID = 1L;

	@Temporal(TemporalType.DATE)
	private Date tran_date               ; // DATE,
	
	@Id
	@Column(length=9)
	private String tran_id                 ; // VARCHAR2(9 BYTE),
